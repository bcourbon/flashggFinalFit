...
parser.add_option("-f","--flashggCats",help="flashggCats : UntaggedTag_0,UntaggedTag_1,UntaggedTag_2,VBFTag_0")
...
parser.add_option("--intLumi",type='float',default=2.61,help="integrated lumi")
parser.add_option("-H","--high",type='int',default=65,help="Sqrt(S) COM energy for finding strings etc")
parser.add_option("-L","--low",type='int',default=120,help="Sqrt(S) COM energy for finding strings etc")
parser.add_option("--isMultiPdf",default=True,action="store_true",help="Use for multipdf workspaces")
parser.add_option("--doBands",default=True,action="store_true",help="Use to draw bands")
...
parser.add_option("--massStep",type="float",default=1,help="Mass step for calculating bands. Use a large number like 5 for quick running")
